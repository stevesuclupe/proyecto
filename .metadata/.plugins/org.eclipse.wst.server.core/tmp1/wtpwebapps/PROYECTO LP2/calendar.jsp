  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="frmIntranetUsuario.jsp" class="logo"><b>DASHGUM FREE</b></a>
      
            <div class="top-menu">
            	<ul class="nav pull-right top-menu">
                    <li><a class="logout" href="LoginIntanet.jsp">Logout</a></li>
            	</ul>
            </div>
        </header>
      <!--header end-->
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li><a  href="frmNuevoEquipo.jsp">Nuevo Equipo</a></li>
                           <li><a  href="frmNuevoEquipo.jsp">Editar Equipo</a></li>
